...
format: 
  pdf: 
    ...
    header-includes:
      ...
      - \newtcolorbox{pythonheader}{colback=blue!20!white, colframe=blue!75!black, fontupper=\bfseries, boxrule=0.5mm, arc=4mm, left=2mm, right=2mm, top=1mm, bottom=1mm}
      - \newtcolorbox{rheader}{colback=cyan!20!white, colframe=cyan!75!black, fontupper=\bfseries, boxrule=0.5mm, arc=4mm, left=2mm, right=2mm, top=1mm, bottom=1mm}
      - \newtcolorbox{bashheader}{colback=gray!20!white, colframe=blue!75!black, fontupper=\bfseries, boxrule=0.5mm, arc=4mm, left=2mm, right=2mm, top=1mm, bottom=1mm}
execute:
  cache: true
---
